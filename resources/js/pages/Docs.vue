        ...
        <div class="container mx-auto py-8">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> API endpoints and usage documentation for the LaraChat application. </CardDescription>
                </CardHeader>
                <CardContent>
                    <div class="space-y-6">
                        <section>
                            <h3 class="mb-2 text-lg font-semibold">Available Endpoints</h3>
                            <div class="space-y-4">
                                <div>
                                    <h4 class="font-medium">Conversations</h4>
                                    <ul class="ml-2 list-inside list-disc text-sm text-muted-foreground">
